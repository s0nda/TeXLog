...
% File:  "thesis.tex"
%
\documentclass[paper=a4,oneside,footsepline,headinclude=false,footinclude=false,fontsize=11pt,listof=totoc,bibliography=totoc]{scrbook} % one-sided [oneside]
